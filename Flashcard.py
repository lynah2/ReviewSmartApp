...
class Flashcard:
    ...
    def next_card(self):
        ...
        self.data.loc[self.data['English'] == self.current_card['English'], 'responseQuality'] = self.calculate_responseQuality(self.current_card['correct'], self.current_card['repetition'])
...
class Flashcard:
    ...
    def is_known(self):
        ...
        print(self.current_card['correct']) 
        data.loc[data['English'] == self.current_card['English'], 'responseQuality'] = self.calculate_responseQuality(self.current_card['correct'], self.current_card['repetition'])

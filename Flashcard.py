...
class Flashcard:
    ...
    def show_window(self,window):
        ...
        self.right_button = Button(window,image=self.right_img,borderwidth=0,highlightthickness=0, command=lambda: (self.is_known(window)))
        self.right_button.grid(row=1, column=0,pady='10')
        self.wrong_button = Button(window,image=self.wrong_img,borderwidth=0,highlightthickness=0, command=lambda: (self.next_card(window)))

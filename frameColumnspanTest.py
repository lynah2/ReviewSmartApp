...
nb = fCard.get_nb_cards()
nb_passed = fCard.get_nb_passed() 
button=Button(frame, text='frToEng', font=("Courrier", 25),bg='yellow' , fg='white', height=3, width=19,command=lambda :fCard.show_window(create_new_window(root)))
...
button6=Button(frame,image=image_ajout1,borderwidth=0, cursor='hand2',command=fCard.ajouter_carte)
button6.grid(pady=1, padx=0, row=2, column=3,sticky="w")
button7=Button(frame,image=image_ajout2,borderwidth=0, cursor='hand2',command=fCard.modifier_carte)
button7.grid(pady=1, padx=0, row=2, column=4, sticky="w")
button8=Button(frame,image=image_ajout3,borderwidth=0, cursor='hand2', command=fCard.dashboard)
...
button10=Button(frame,image=image_ajout5,borderwidth=0, cursor='hand2', command=fCard.supprimer_carte)

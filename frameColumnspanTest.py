    ...
    with open("flashcards.csv") as f:
        ...
        for row in reader:
            if len(row)>0:
              ...
              button=Button(info_frame, text=row[2], font=("Courrier", 25),cursor='hand2', height=3, width=19, bg=row[3], fg='white', command=fCard.show_window)
...
button=Button(frame, text='frToEng', font=("Courrier", 25),bg='#FAD727' , fg='white', height=3, width=19, command=run_python_script)

...
class flashCard:
    def __init__(self, label, recto, verso, color):
        self.label = label
        self.recto = recto
        self.verso = verso
        self.color = color
    ...
    def graph(self):
          ...
          labelCsvFile='learn_'+ self.label + '.csv'
          with open(labelCsvFile, 'r') as csvfile:
    ...
    def hangman(self):
        ...
        while run:
           ...
           # choosing word
           labelCsvFile=self.label + '.csv'
           with open(labelCsvFile) as f:
              l= csv.reader(f)
              rows = list(l)
